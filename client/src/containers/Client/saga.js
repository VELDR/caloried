...
import { loginApi, registerApi, resendVerificationEmailApi } from '@domain/api';
import toast from 'react-hot-toast';
import { takeLatest, call, put } from 'redux-saga/effects';
import { LOGIN, REGISTER, RESEND_VERIFICATION_EMAIL } from './constants';
import { setFirstLogin, setLogin, setToken } from './actions';
